...
func main() {
	...
	api := router.Group("/api")
	{
		...
		api.GET("/activity/:username", getActivityByUsernameHandler)
		api.GET("/stats/:username", getStatsHandler)
		...
		// Category types (values list)
		api.GET("/category-types", getCategoryTypesHandler)
		api.POST("/category-types", createCategoryTypeHandler)
		api.PUT("/category-types/:id", updateCategoryTypeHandler)
		api.DELETE("/category-types/:id", deleteCategoryTypeHandler)
